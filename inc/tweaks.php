...
***/
function simplicize_title( $title, $sep ) {
	global $paged, $page;
...
add_filter( 'wp_title', 'simplicize_title', 10, 2 );


/*** 
 * Add page slug as body class. also include the page parent 
***/
function simplicize_body_classes($classes, $class='') {
	global $wp_query;
...
add_filter('body_class','simplicize_body_classes');
